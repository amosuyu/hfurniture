...
class ValidateCollections extends FormRequest
{
    /**
    ...
    {
        return [
            'name_vi.required' => 'Tên bộ sưu tập không được để trống!',
            'name_vi.max' => 'Tên bộ sưu tập không được vượt qúa 100 ký tự!',
            'name_en.max' => 'Tên bộ sưu tập không được vượt qúa 100 ký tự!',
