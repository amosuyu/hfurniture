...
@section('pageTitle', 'Thêm chính sách')
@section('breadcrumb-first', 'Chính sách')
@section('breadcrumb-second', 'Thêm chính sách')
@section('main')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <form action="{{ route('chinh-sach.store') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10 d-flex">
                            ...
                            <div class="custom-control custom-radio mr-2">
                                <input type="radio" id="show" name="display" value="1" class="custom-control-input" checked>
