...
@section('main')
    <a href="{{ route('blog.index') }}"><i class="fa fa-angle-double-left"></i>&nbsp;Quay lại</a>
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select class="form-control select2" value="{{ old('blog_type_id') }}" id="example-text-input"
                                name="blog_type_id">
                                <option value="">Chọn loại tin</option>
                                @foreach ($Blogtypes as $Blogtype)
                                    <option value="{{ $Blogtype->id }}" @if (old('blog_type_id') == $Blogtype->id) selected @endif>{{ $Blogtype->title }}
                                    </option>
                                @endforeach
                            </select>
                            @error('blog_type_id')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <textarea class="form-control" type="text" value="{{ old('description') }}"
                                ...
                                placeholder="Nhập mô tả...">{{ old('description') }}</textarea>
                            @error('description')
                                <div style="color:red" class="ml-1">
                                    <i class="typcn typcn-delete"></i> {{ $message }}
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="{{ old('slug') }}" id="example-text-input"
