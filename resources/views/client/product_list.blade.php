                                ...
                                <div role="tabpanel" class="tab-pane active" id="grid-view">
                                    <div class="row">
                                        ...
                                        @if (!$products->isEmpty())
                                            ...
                                            @endforeach
                                        @else <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                {{ trans('message.products_empty') }}</div>
                                        @endif
                            ...
                            <div>
                                <ul>
                                    @foreach ($categories as $category)
                                        <li>
                                            <a style="{{ $category->id == request()->route('id') ? 'color:#ff7f00' : '' }}"
                                                href="{{ route('productsByCategory', $category->id) }}">
                                                @if (Session::get('website_language') == 'en')
